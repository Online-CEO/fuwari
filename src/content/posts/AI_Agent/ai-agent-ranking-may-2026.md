---
title: 2026 年 5 月 AI Agent 排行榜：这 8 个产品，最值得关注
...
也就是说，这不是“模型智商排行榜”，而是更偏**现在谁更像一个真正能用的 Agent 产品**。
...
OpenAI 在 **2026 年 4 月 16 日**发布的 [Codex for (almost) everything](https://openai.com/index/codex-for-almost-everything/) 里，已经把 Codex 的定位拉得非常明确：
...
再往前看，OpenAI 在 **2026 年 2 月 2 日**发布 [Introducing the Codex app](https://openai.com/index/introducing-the-codex-app/) 时，就已经把它定义成一个 **command center for agents**。
...
OpenAI 在 **2026 年 4 月 22 日**发布 [Introducing workspace agents in ChatGPT](https://openai.com/index/introducing-workspace-agents-in-chatgpt/) 时，给出的信号非常强：
...
- [Cognition 官网](https://cognition.ai/)
- [Devin Knowledge Base](https://knowledge.cognition.ai/)
...
Google 在 **2025 年 5 月 20 日**就已经把 [Jules public beta](https://blog.google/technology/google-labs/jules) 推出来了，而最近的官方更新更关键：

- [Jules 结束公测，开始全面可用](https://blog.google/technology/google-labs/jules-now-available/)
- 现在由 Gemini 2.5 驱动
- 支持复用之前的 setup
...
- [Welcome / Docs](https://manus.im/docs)
- [About Manus](https://manus.im/about)
...
- [Agent Skills](https://manus.im/features/agent-skills)
...
- [How to use Project Mariner](https://support.google.com/labs/answer/16270604?hl=en)
- [Workspace Admin 控制说明](https://support.google.com/a/answer/16523554?hl=en)
...
- [About OpenHands](https://docs.all-hands.dev/usage/about)
- [Agents](https://docs.all-hands.dev/openhands/usage/agents)
- [Runtimes](https://docs.all-hands.dev/openhands/usage/runtimes/overview)
...
- [Google: Jules public beta](https://blog.google/technology/google-labs/jules)
- [Google: Jules now available](https://blog.google/technology/google-labs/jules-now-available/)
- [Google: How to use Project Mariner](https://support.google.com/labs/answer/16270604?hl=en)
- [Google Workspace Admin: Project Mariner](https://support.google.com/a/answer/16523554?hl=en)
- [Cognition](https://cognition.ai/)
- [Devin Knowledge Base](https://knowledge.cognition.ai/)
- [Manus Docs](https://manus.im/docs)
- [Manus About](https://manus.im/about)
- [Manus Blog](https://manus.im/blog)
- [OpenHands Docs](https://docs.all-hands.dev/usage/about)
